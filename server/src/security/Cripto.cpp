...
std::string str;
    ...
    void Cripto::setKey(const char key[17])
    {
      gcry_error_t gcryError;
            ...
            if (gcryError)
              std::cout << "gcry_cipher_setkey failed:  "<< gcry_strsource(gcryError) << gcry_strerror(gcryError) << std::endl;
     }
    ...
    void Cripto::setIv(const char iv[17])
    {
      gcry_error_t gcryError;
            ...
            if (gcryError)
             ...
             std::cout << "gcry_cipher_setIv failed: " << gcry_strsource(gcryError) << gcry_strerror(gcryError) << std::endl;
    }
