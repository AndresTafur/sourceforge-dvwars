...
public:
             ...
             */
            GameObject( unsigned int player, Ogre::SceneManager *sceneMgr, Ogre::String mesh, std::string name = "");

            /**
             * Instantiates a GameObject. Instantiation its done by loading mesh.
             *
             * @param sceneMgr Current sceneManager.
             * @param entity  Mesh to be loaded.
             * @param name  (Optional) Name to be assigned to the mesh.
             */
            ...
            inline void setOwner(unsigned int val) { mPlayer = val;}

            inline unsigned int getOwner() { return mPlayer;}
